...
var bannedUserIdsPerDocument = 30000;

//track if we already commented on a specific media
const commentDataTableName = "instagram-comment-data";

//our firestore reference so we can authenticate connecting
const firestore = new Firestore({
	projectId: myProjectId,
	keyFilename: 'My-Project-1234.json'
});
...
const homePage = 'https://www.instagram.com';

//where do we login
const loginPage = 'https://www.instagram.com/accounts/login/';

//the url to get a list of users we are following
const followingJsonPage = 'https://www.instagram.com/graphql/query/?query_id=17874545323001329&id=2223628835&first=50';

//profile page providing json data about a user
const profileJsonPage = 'https://www.instagram.com/%s/?__a=1'

//the profile page of a user
const profilePage = 'https://www.instagram.com/%s';

//the page where we like / comment
const mediaPage = 'https://www.instagram.com/p/%s/';

//page listing recent media for a specific tag
const tagsPage = 'https://www.instagram.com/explore/tags/%s/?__a=1';

//how many people are we allowed to follow (max)
const followingMax = 7500;

//if the difference between following and followers is less than this number, we need to start unfollowing
const followingThreshold = 100;
...
const accountNameDesc = 'Games By Kevin';

//list of tags where we will "like / comment / follow"
const tags = ['gamedev', 'retro', 'gaming', '8bit', 'game', 'games', 'android', 'gameart', 'gamer', 'gamers', 'beautiful', 'amazing', 'fun', 'art', 'gaming', 'lol', 'happy'];

//list of names, if a users account contains this name we will ignore them
const ignore = ['money', 'fortnite', 'free', 'follow', 'raffle', 'pokemon', 'store', 'cash', 'money'];
...
var maxComments = 80;
var maxFollows = 150;
var maxUnfollows = 150;

//how many times can we (like, follow, comment) each time this app runs
const actionLimit = 4;
